...
avatar = media.Movie("Avatar",
                     ...
                     "https://upload.wikimedia.org/wikipedia/en/thumb/b/b0/Avatar-Teaser-Poster.jpg/" + 
                     "220px-Avatar-Teaser-Poster.jpg",
                     "https://www.youtube.com/watch?v=5PSNL1qE6VY")


hitch = media.Movie("Hitch", 
                    "Dating coach Alex Hitchens mentors a bumbling client, Albert," +
                    " who hopes to win the heart of the glamorous Allegra Cole",
...
school_of_rock = media.Movie("School of Rock", "Teacher uses music to teach kids", 
               "https://upload.wikimedia.org/wikipedia/en/thumb/1/11/School_of_Rock_Poster.jpg/"+
